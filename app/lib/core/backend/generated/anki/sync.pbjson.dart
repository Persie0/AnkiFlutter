  ...
  '2': [
    {
      ...
      '4': 1,
      '5': 14,
      '6': '.anki.sync.SyncStatusResponse.Required',
      '10': 'required'
    },
    {
      '1': 'new_endpoint',
...
const SyncCollectionResponse$json = {
  ...
  '2': [
    ...
    {'1': 'server_message', '3': 2, '4': 1, '5': 9, '10': 'serverMessage'},
    {
      ...
      '4': 1,
      '5': 14,
      '6': '.anki.sync.SyncCollectionResponse.ChangesRequired',
      '10': 'required'
    },
    {
      '1': 'new_endpoint',
...
final $typed_data.Uint8List fullUploadOrDownloadRequestDescriptor =
...
final $typed_data.Uint8List syncServiceDescriptor =
    $convert.base64Decode('CgtTeW5jU2VydmljZQ==');
...
const $core.Map<$core.String, $core.dynamic> BackendSyncServiceBase$json = {
  ...
  '2': [
    ...
    },
    {
      '1': 'MediaSyncStatus',
      '2': '.anki.generic.Empty',
      '3': '.anki.sync.MediaSyncStatusResponse'
    },
    {
      '1': 'SyncLogin',
      '2': '.anki.sync.SyncLoginRequest',
      '3': '.anki.sync.SyncAuth'
    },
    {
      '1': 'SyncStatus',
      '2': '.anki.sync.SyncAuth',
      '3': '.anki.sync.SyncStatusResponse'
    },
    {
      '1': 'SyncCollection',
      '2': '.anki.sync.SyncCollectionRequest',
      '3': '.anki.sync.SyncCollectionResponse'
    },
    {
      '1': 'FullUploadOrDownload',
      '2': '.anki.sync.FullUploadOrDownloadRequest',
      '3': '.anki.generic.Empty'
    },
    {'1': 'AbortSync', '2': '.anki.generic.Empty', '3': '.anki.generic.Empty'},
    {
      '1': 'SetCustomCertificate',
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
    BackendSyncServiceBase$messageJson = {
...
final $typed_data.Uint8List backendSyncServiceDescriptor = $convert.base64Decode(
    ...
    'ZW5lcmljLkVtcHR5EkAKFFNldEN1c3RvbUNlcnRpZmljYXRlEhQuYW5raS5nZW5lcmljLlN0cm'
    'luZxoSLmFua2kuZ2VuZXJpYy5Cb29s');
