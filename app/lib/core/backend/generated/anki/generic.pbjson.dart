...
@$core.Deprecated('Use int32Descriptor instead')
const Int32$json = {
  '1': 'Int32',
  '2': [
    {'1': 'val', '3': 1, '4': 1, '5': 17, '10': 'val'},
  ],
};

/// Descriptor for `Int32`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List int32Descriptor =
    $convert.base64Decode('CgVJbnQzMhIQCgN2YWwYASABKBFSA3ZhbA==');

@$core.Deprecated('Use uInt32Descriptor instead')
const UInt32$json = {
  '1': 'UInt32',
  '2': [
    {'1': 'val', '3': 1, '4': 1, '5': 13, '10': 'val'},
  ],
};

/// Descriptor for `UInt32`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List uInt32Descriptor =
    $convert.base64Decode('CgZVSW50MzISEAoDdmFsGAEgASgNUgN2YWw=');
...
final $typed_data.Uint8List int64Descriptor =
    $convert.base64Decode('CgVJbnQ2NBIQCgN2YWwYASABKANSA3ZhbA==');
...
final $typed_data.Uint8List stringDescriptor =
    $convert.base64Decode('CgZTdHJpbmcSEAoDdmFsGAEgASgJUgN2YWw=');
