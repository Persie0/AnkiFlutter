...
const CloseCollectionRequest$json = {
  ...
  '2': [
    {
      '1': 'downgrade_to_schema11',
      '3': 1,
      '4': 1,
      '5': 8,
      '10': 'downgradeToSchema11'
    },
  ],
};

/// Descriptor for `CloseCollectionRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List closeCollectionRequestDescriptor =
...
final $typed_data.Uint8List checkDatabaseResponseDescriptor =
    $convert.base64Decode(
...
@$core.Deprecated('Use nestedOpChangesDescriptor instead')
const NestedOpChanges$json = {
  '1': 'NestedOpChanges',
  '2': [
    {
      '1': 'changes',
      ...
      '4': 1,
      '5': 11,
      '6': '.anki.collection.OpChangesOnly',
      '10': 'changes'
    },
  ],
};

/// Descriptor for `NestedOpChanges`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List nestedOpChangesDescriptor = $convert.base64Decode(
    'Cg9OZXN0ZWRPcENoYW5nZXMSOAoHY2hhbmdlcxgBIAEoCzIeLmFua2kuY29sbGVjdGlvbi5PcE'
    'NoYW5nZXNPbmx5UgdjaGFuZ2Vz');
...
const OpChangesAfterUndo$json = {
  ...
  '2': [
    ...
    {
      '1': 'reverted_to_timestamp',
      '3': 3,
      '4': 1,
      '5': 3,
      '10': 'revertedToTimestamp'
    },
    {
      '1': 'new_status',
      '3': 4,
...
const Progress$json = {
  ...
  '2': [
    ...
    {'1': 'media_check', '3': 3, '4': 1, '5': 9, '9': 0, '10': 'mediaCheck'},
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.anki.collection.Progress.FullSync',
      '9': 0,
      '10': 'fullSync'
    },
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.anki.collection.Progress.NormalSync',
      '9': 0,
      '10': 'normalSync'
    },
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.anki.collection.Progress.DatabaseCheck',
      '9': 0,
      '10': 'databaseCheck'
    },
    ...
    {'1': 'exporting', '3': 8, '4': 1, '5': 9, '9': 0, '10': 'exporting'},
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.anki.collection.ComputeParamsProgress',
      '9': 0,
      '10': 'computeParams'
    },
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.anki.collection.ComputeRetentionProgress',
      '9': 0,
      '10': 'computeRetention'
    },
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.anki.collection.ComputeMemoryProgress',
      '9': 0,
      '10': 'computeMemory'
    },
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.anki.collection.DownloadUpdateProgress',
      '9': 0,
      '10': 'downloadUpdate'
    },
  ],
  '3': [
    Progress_FullSync$json,
    Progress_NormalSync$json,
    Progress_DatabaseCheck$json
  ],
  '8': [
    {'1': 'value'},
  ],
...
final $typed_data.Uint8List progressDescriptor = $convert.base64Decode(
    ...
    'ABKAlIAFIJaW1wb3J0aW5nEh4KCWV4cG9ydGluZxgIIAEoCUgAUglleHBvcnRpbmcSTwoOY29t'
    'cHV0ZV9wYXJhbXMYCSABKAsyJi5hbmtpLmNvbGxlY3Rpb24uQ29tcHV0ZVBhcmFtc1Byb2dyZX'
    'NzSABSDWNvbXB1dGVQYXJhbXMSWAoRY29tcHV0ZV9yZXRlbnRpb24YCiABKAsyKS5hbmtpLmNv'
    'bGxlY3Rpb24uQ29tcHV0ZVJldGVudGlvblByb2dyZXNzSABSEGNvbXB1dGVSZXRlbnRpb24STw'
    'oOY29tcHV0ZV9tZW1vcnkYCyABKAsyJi5hbmtpLmNvbGxlY3Rpb24uQ29tcHV0ZU1lbW9yeVBy'
    'b2dyZXNzSABSDWNvbXB1dGVNZW1vcnkSUgoPZG93bmxvYWRfdXBkYXRlGAwgASgLMicuYW5raS'
    '5jb2xsZWN0aW9uLkRvd25sb2FkVXBkYXRlUHJvZ3Jlc3NIAFIOZG93bmxvYWRVcGRhdGUaQgoI'
    'RnVsbFN5bmMSIAoLdHJhbnNmZXJyZWQYASABKA1SC3RyYW5zZmVycmVkEhQKBXRvdGFsGAIgAS'
    'gNUgV0b3RhbBpSCgpOb3JtYWxTeW5jEhQKBXN0YWdlGAEgASgJUgVzdGFnZRIUCgVhZGRlZBgC'
    'IAEoCVIFYWRkZWQSGAoHcmVtb3ZlZBgDIAEoCVIHcmVtb3ZlZBprCg1EYXRhYmFzZUNoZWNrEh'
    'QKBXN0YWdlGAEgASgJUgVzdGFnZRIfCgtzdGFnZV90b3RhbBgCIAEoDVIKc3RhZ2VUb3RhbBIj'
    'Cg1zdGFnZV9jdXJyZW50GAMgASgNUgxzdGFnZUN1cnJlbnRCBwoFdmFsdWU=');

@$core.Deprecated('Use computeParamsProgressDescriptor instead')
const ComputeParamsProgress$json = {
  '1': 'ComputeParamsProgress',
  '2': [
...
/// Descriptor for `ComputeParamsProgress`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List computeParamsProgressDescriptor = $convert.base64Decode(
    'ChVDb21wdXRlUGFyYW1zUHJvZ3Jlc3MSGAoHY3VycmVudBgBIAEoDVIHY3VycmVudBIUCgV0b3'
    'RhbBgCIAEoDVIFdG90YWwSGAoHcmV2aWV3cxgDIAEoDVIHcmV2aWV3cxIlCg5jdXJyZW50X3By'
    'ZXNldBgEIAEoDVINY3VycmVudFByZXNldBIjCg10b3RhbF9wcmVzZXRzGAUgASgNUgx0b3RhbF'
    'ByZXNldHM=');
...
final $typed_data.Uint8List computeRetentionProgressDescriptor =
    $convert.base64Decode(
...
@$core.Deprecated('Use getCustomColoursResponseDescriptor instead')
const GetCustomColoursResponse$json = {
  '1': 'GetCustomColoursResponse',
  '2': [
    {'1': 'colours', '3': 1, '4': 3, '5': 9, '10': 'colours'},
  ],
};

/// Descriptor for `GetCustomColoursResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getCustomColoursResponseDescriptor =
    $convert.base64Decode(
        'ChhHZXRDdXN0b21Db2xvdXJzUmVzcG9uc2USGAoHY29sb3VycxgBIAMoCVIHY29sb3Vycw==');

@$core.Deprecated('Use downloadUpdateProgressDescriptor instead')
const DownloadUpdateProgress$json = {
  '1': 'DownloadUpdateProgress',
  '2': [
    {'1': 'downloaded_bytes', '3': 1, '4': 1, '5': 13, '10': 'downloadedBytes'},
    {'1': 'total_bytes', '3': 2, '4': 1, '5': 13, '10': 'totalBytes'},
  ],
};

/// Descriptor for `DownloadUpdateProgress`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List downloadUpdateProgressDescriptor =
    $convert.base64Decode(
        'ChZEb3dubG9hZFVwZGF0ZVByb2dyZXNzEikKEGRvd25sb2FkZWRfYnl0ZXMYASABKA1SD2Rvd2'
        '5sb2FkZWRCeXRlcxIfCgt0b3RhbF9ieXRlcxgCIAEoDVIKdG90YWxCeXRlcw==');
  ...
  '2': [
    {
      ...
      '3': '.anki.collection.CheckDatabaseResponse'
    },
    {
      '1': 'GetUndoStatus',
      '2': '.anki.generic.Empty',
      '3': '.anki.collection.UndoStatus'
    },
    {
      '1': 'Undo',
      '2': '.anki.generic.Empty',
      '3': '.anki.collection.OpChangesAfterUndo'
    },
    {
      '1': 'Redo',
      '2': '.anki.generic.Empty',
    ...
    },
    {
      '1': 'GetCustomColours',
      '2': '.anki.generic.Empty',
      '3': '.anki.collection.GetCustomColoursResponse'
    },
  ],
};
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
    CollectionServiceBase$messageJson = {
  ...
  '.anki.collection.ComputeParamsProgress': ComputeParamsProgress$json,
  ...
  '.anki.collection.DownloadUpdateProgress': DownloadUpdateProgress$json,
  '.anki.generic.Bool': $0.Bool$json,
  '.anki.collection.GetCustomColoursResponse': GetCustomColoursResponse$json,
};
...
final $typed_data.Uint8List collectionServiceDescriptor = $convert.base64Decode(
    ...
    'dHkSSAoWU2V0TG9hZEJhbGFuY2VyRW5hYmxlZBISLmFua2kuZ2VuZXJpYy5Cb29sGhouYW5raS'
    '5jb2xsZWN0aW9uLk9wQ2hhbmdlcxJSChBHZXRDdXN0b21Db2xvdXJzEhMuYW5raS5nZW5lcmlj'
    'LkVtcHR5GikuYW5raS5jb2xsZWN0aW9uLkdldEN1c3RvbUNvbG91cnNSZXNwb25zZQ==');
...
const $core.Map<$core.String, $core.dynamic> BackendCollectionServiceBase$json =
  ...
  '2': [
    {
      '1': 'OpenCollection',
      '2': '.anki.collection.OpenCollectionRequest',
      '3': '.anki.generic.Empty'
    },
    {
      '1': 'CloseCollection',
      '2': '.anki.collection.CloseCollectionRequest',
      '3': '.anki.generic.Empty'
    },
    {
      '1': 'CreateBackup',
      '2': '.anki.collection.CreateBackupRequest',
      '3': '.anki.generic.Bool'
    },
    {
      '1': 'AwaitBackupCompletion',
      '2': '.anki.generic.Empty',
      '3': '.anki.generic.Empty'
    },
    {
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
    BackendCollectionServiceBase$messageJson = {
